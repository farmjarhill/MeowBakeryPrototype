    ...
    <div class="footer-middle container">
      <div class="row row-cols-lg-5 row-cols-2">
        <div class="footer-column footer-store-info mb-4 mb-lg-0">
          <div class="logo">
            <a href="index.php">
              <img src="../images/logoMeowBakery.png" alt="MeoBakery" class="logo__image d-block" />
            </a>
          </div><!-- /.logo -->
  ...
  <!------------ End Footer Type 1 ------------>
    ...
    <div class="row text-center">
      ...
      <div class="col-4">
        <a href="shop1.php" class="footer-mobile__link d-flex flex-column align-items-center">
      ...
      <div class="col-4">
        <a href="shop_cart.php" class="footer-mobile__link d-flex flex-column align-items-center">
