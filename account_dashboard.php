      ...
      <div class="row">
        <div class="col-lg-3">
          <ul class="account-nav">
            <li><a href="account_dashboard.php" class="menu-link menu-link_us-s menu-link_active">Dashboard</a></li>
            <li><a href="products_management/product.php" class="menu-link menu-link_us-s menu-link_us-s">Products</a></li>
        ...
        <div class="col-lg-9">
          <div class="page-content my-account__dashboard">
            <p>Hello <strong>thomashien0703</strong> (not <strong>thomashien0703?</strong> <a href="login_register.php">Log out</a>)</p>
          </div>
        </div>
      
      </div>
      <?php include "indexdashboard.php" ?>
    </section>
  </main>
